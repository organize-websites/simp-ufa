...
import 'package:simp/homeb2cor2.dart';
...
class _Homeb2corState extends State<Homeb2cor> {
  ...
  navOutra() {
    Navigator.push(context, MaterialPageRoute(builder: (context) => B2cor2()));
  }
        ...
        children: [
          Center(
            child:FutureBuilder(
              ...
              : Image.asset('imagens/b2cor-gif.gif', width: 150, height: 150,)),
          ),
          Container(color: Colors.white, child: Center(child: Image.asset('imagens/b2cor-gif.gif', width: 150, height: 150,)))
        ],
      ),
    ),
    drawer: 
