    ...
    body: Padding(
      ...
      child: Stack(
        children: [
          WebView(
            key: _key,
            initialUrl: 'https://b2cor-crm.agencialink.com.br/a_adm/home/mobile/',
          ...
          isLoading ? Container(color: Colors.white, child: Center(child: Image.asset('imagens/b2cor-gif.gif', width: 150, height: 150,)))
          : Stack(),
        ],
      ),
    ),
